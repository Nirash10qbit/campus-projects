...
public class zlabgamec extends AppCompatActivity {

    String st,st0,st1,st2,st3,st4,st5,st6,st8,st9,st10,stn,stl,stg,sta,stb,stz,stqa,stqb,stqc,stqd,stqe,staa,stab,stac,stad,stae,totalb,totalc,ra,rb,rc;
    TextView tv1,tv2,tv3,tv8,tv9,tv10;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_zlabgamec);
        ...
        totalb = getIntent().getExtras().getString("totalb");
        tv2.setText(totalb);
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int i, long l) {
                ...
                if(leone == letwo){
                    ...
                    int tmaks = Integer.valueOf(totalb);
                    final int tbmarks = tmaks + 0;

                    totalc = String.valueOf(tbmarks);

                    MediaPlayer mysong = MediaPlayer.create (zlabgamec.this,R.raw.omai);
                    mysong.start ();
                    ...
                    handler.postDelayed (new Runnable ( ) {
                        @Override
                        public void run() {
                            Intent intent = new Intent(zlabgamec.this,zlabgamed.class);
                    ...
                    MediaPlayer mysong = MediaPlayer.create (zlabgamec.this,R.raw.mix);
                    mysong.start ();
        ...
        JsonArrayRequest request = new JsonArrayRequest(Request.Method.GET, url, null,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(zlabgamec.this, "Please check your internet connection.", Toast.LENGTH_SHORT).show();
