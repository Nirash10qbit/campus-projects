...
public class zlabgameb extends AppCompatActivity {

    String st,st0,st1,st2,st3,st4,st5,st6,st8,st9,st10,stn,stl,stg,sta,stb,stz,stqa,stqb,stqc,stqd,stqe,staa,stab,stac,stad,stae,total,totalb,ra,rb;
    TextView tv1,tv2,tv8,tv9,tv10;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_zlabgameb);
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int i, long l) {
                ...
                if(leone == letwo){
                    ...
                    int tmaks = Integer.valueOf(total);
                    final int tbmarks = tmaks + 0;

                    totalb = String.valueOf(tbmarks);

                    MediaPlayer mysong = MediaPlayer.create (zlabgameb.this,R.raw.omai);
                    mysong.start ();
                    ...
                    handler.postDelayed (new Runnable ( ) {
                        @Override
                        public void run() {
                            Intent intent = new Intent(zlabgameb.this,zlabgamec.class);
                    ...
                    MediaPlayer mysong = MediaPlayer.create (zlabgameb.this,R.raw.mix);
                    mysong.start ();
        ...
        JsonArrayRequest request = new JsonArrayRequest(Request.Method.GET, url, null,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(zlabgameb.this, "Please check your internet connection.", Toast.LENGTH_SHORT).show();
