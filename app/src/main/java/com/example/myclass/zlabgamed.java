...
public class zlabgamed extends AppCompatActivity {
    ...
    String st,st0,st1,st2,st3,st4,st5,st6,st8,st9,st10,stn,stl,stg,sta,stb,stz,stqa,stqb,stqc,stqd,stqe,staa,stab,stac,stad,stae,totalc,totald,ra,rb,rc,rd;
    TextView tv1,tv2,tv3,tv4,tv8,tv9,tv10;
