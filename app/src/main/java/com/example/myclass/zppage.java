...
public class zppage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_zppage);
        ...
        new zppage.Retrivepddf ().execute(st30);
    ...
    public void paper(View view){
        Intent intent = new Intent (this, zpaper.class);
