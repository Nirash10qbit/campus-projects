...
public class zlabgamee extends AppCompatActivity {

    String st,st0,st1,st2,st3,st4,st5,st6,st8,st9,st10,stn,stl,stg,sta,stb,stz,stqa,stqb,stqc,stqd,stqe,staa,stab,stac,stad,stae,totald,totale,ra,rb,rc,rd,re;
    TextView tv1,tv2,tv3,tv4,tv5,tv8,tv9,tv10;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_zlabgamee);
        ...
        tv4.setText(rc);
        tv5 = findViewById(R.id.gidnew10);
        ...
        webView.loadUrl(stqe);

        tv2 = findViewById(R.id.gidnew6);
        totald = getIntent().getExtras().getString("totald");
        tv2.setText(totald);
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int i, long l) {
                ...
                if(leone == letwo){
                    ...
                    int tmaks = Integer.valueOf(totald);
                    final int tbmarks = tmaks;

                    totale = String.valueOf(tbmarks);

                    MediaPlayer mysong = MediaPlayer.create (zlabgamee.this,R.raw.omai);
                    mysong.start ();
                    ...
                    handler.postDelayed (new Runnable ( ) {
                        @Override
                        public void run() {
                            Intent intent = new Intent(zlabgamee.this,zlabgamef.class);
                    ...
                    MediaPlayer mysong = MediaPlayer.create (zlabgamee.this,R.raw.mix);
                    mysong.start ();
        ...
        JsonArrayRequest request = new JsonArrayRequest(Request.Method.GET, url, null,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(zlabgamee.this, "Please check your internet connection.", Toast.LENGTH_SHORT).show();
    ...
    public void setSessions(JSONArray response){
        ...
        try{
            for(int i=0;i <response.length()  ;i++){
                ...
                map.put("ne",obj.getString("ne"));
                map.put("ane",obj.getString("ane"));
