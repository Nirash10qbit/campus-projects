...
public class zpage extends AppCompatActivity {

    private static final int RERMISSION_STORAGE_CODE = 1000 ;
    String st,st0,st1,st2,st3,st4,st5,st6,st16,st17,st18,st20,st30,st31,stn,stl,stg;
    TextView uname1,tv,tv0,tv1,tv2,tv3,tv4,tv5,tv6,tv16,tv17,tv18,tv20;
    PDFView pdfView;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_zpage);
        ...
        new zpage.Retrivepddf ().execute(st30);
