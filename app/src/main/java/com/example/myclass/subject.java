...
public class subject extends AppCompatActivity {
    ...
    String st,st0,st1,st2,st3,st8,st9,stn;
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int i, long l) {
                ...
                if(leone == letwo){
                    ...
                    Intent intent = new Intent(getApplicationContext(),vlesson.class);   //   Grade 001 / 002 / 003 / 004 / 005
                    intent.putExtra("uname", stn);
                    intent.putExtra("value",st);
                    intent.putExtra("gid",st1);
                    intent.putExtra("SIDNAME",st2);
                    ...
                    Intent intent = new Intent(getApplicationContext(),plesson.class);   //   Grade  08 / 09 / 10 / 11 /12
                    intent.putExtra("uname", stn);
                    intent.putExtra("value",st);
                    intent.putExtra("gid",st1);
                    intent.putExtra("SIDNAME",st2);
