...
public class vlesson extends AppCompatActivity {

    private static final int RERMISSION_STORAGE_CODE = 1000 ;
    String st,st0,st1,st2,st3,st4,st5,st6,st16,st17,st18,st20,stn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vlesson);
        ...
        lv1.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int i, long l) {
                ...
                Intent intent = new Intent(getApplicationContext(),vpage.class);
    ...
    public void dcsub(View view){
        ...
        Intent intent = new Intent(getApplicationContext(),dcsubject.class);
        intent.putExtra("uname", stn);
        intent.putExtra("value",st);
        intent.putExtra("gid",st1);
        intent.putExtra("sid",st3);
    ...
    public void addvless(View view){
        getIntent().getExtras().getString("value");
        getIntent().getExtras().getString("gid");
        getIntent().getExtras().getString("sid");
        ...
        JsonArrayRequest request = new JsonArrayRequest(Request.Method.GET, url1, null,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(vlesson.this, "Please check your internet connection.", Toast.LENGTH_SHORT).show();
    ...
    public void setSessions1(JSONArray response){
        ...
        try{
            ...
            //2.views
            int[] views = {R.id.tvgid1,R.id.tvsid1, R.id.tvcid,R.id.tvcidname,R.id.tvcidact, R.id.tvcidpdf, R.id.tvcvideo};
            //3.Columms
            String[]  columns = {"gid","sid","cid","cidname","cact","cpdf","cvideo"};
